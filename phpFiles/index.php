        ...
        <div id="centerwrapper">
            <div id="centerdiv">
                ...
                <input type="radio" name="user_type" value="user" checked="checked"> User
                    ...
                    <input type="radio" name="user_type" value="veterinarian"> Veterinarian
                    <input type="radio" name="user_type" value="keeper"> Keeper
                    <input type="radio" name="user_type" value="coordinator"> Coordinator
                    <input type="radio" name="user_type" value="advertiser"> Advertiser
